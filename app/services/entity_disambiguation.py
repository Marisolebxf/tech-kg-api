...
KB = [
    {
        ...
        "keywords": ["科技", "iPhone", "MacBook", "iPad", "乔布斯", "库克", "股价", "发布", "上市", "研发", "芯片", "App Store"],
    },
    {
        "id": "KB002",
        "name": "苹果",
        ...
        "keywords": ["水果", "营养", "维生素", "食用", "健康", "膳食纤维", "消化", "种植", "采摘", "果园", "红富士"],
    },
    {
        "id": "KB003",
        "name": "迈克尔·乔丹",
        ...
        "keywords": ["NBA", "篮球", "公牛", "冠军", "球员", "运动", "总冠军", "23号", "进攻", "得分", "扣篮"],
    },
    {
        "id": "KB004",
        "name": "约旦",
        ...
        "keywords": ["国家", "安曼", "中东", "阿拉伯", "签证", "旅游", "政府", "首都", "领土", "外交"],
    },
    {
        "id": "KB005",
        "name": "长城",
        ...
        "keywords": ["古代", "历史", "秦朝", "秦始皇", "防御", "军事", "文化遗产", "旅游景点", "修建", "遗址", "世界遗产"],
    },
    {
        "id": "KB006",
        "name": "长城汽车",
        ...
        "keywords": ["汽车", "SUV", "哈弗", "坦克", "魏牌", "欧拉", "新能源", "销量", "上市", "制造", "车型", "发布"],
    },
    {
        "id": "KB007",
        "name": "特斯拉公司",
        ...
        "keywords": ["电动车", "Model 3", "马斯克", "自动驾驶", "充电", "续航", "新能源", "股价", "工厂", "纳斯达克"],
    },
    {
        "id": "KB008",
        "name": "尼古拉·特斯拉",
        ...
        "keywords": ["科学家", "发明家", "交流电", "电磁", "发明", "物理", "爱迪生", "电力", "历史", "无线电", "感应"],
    },
    {
        "id": "KB009",
        "name": "亚马逊公司",
        ...
        "keywords": ["电商", "购物", "平台", "下单", "物流", "快递", "AWS", "云计算", "会员", "Prime", "贝索斯", "购买"],
    },
    {
        "id": "KB010",
        "name": "亚马逊河",
        ...
        "keywords": ["河流", "雨林", "南美洲", "巴西", "热带", "生物多样性", "地球之肺", "森林", "生态", "保护", "自然"],
    },
]
...
def disambiguate_entity(
    ...
    *,
    ...
    candidates.sort(
        key=lambda x: (-x["context_rerank_score"], -x["recall_score"], x["kb_index"])
    )
