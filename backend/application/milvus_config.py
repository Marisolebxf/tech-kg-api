"""平台 Milvus 配置 application facade。"""

from __future__ import annotations

from sqlalchemy.orm import Session

from service.milvus_config import MilvusConfigService


class MilvusConfigApplication:
    """薄封装：转发到 MilvusConfigService。"""

    def __init__(self, session: Session) -> None:
        self._service = MilvusConfigService(session)
