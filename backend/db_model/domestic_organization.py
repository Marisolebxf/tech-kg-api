...
class DwdOrgAnnualFinancialInfo(Base):
    ...
    social_credit_code = Column('social_credit_code', String(50), nullable=True, comment='统一社会信用代码')
    year = Column('year', Integer(), nullable=True, comment='年报年度')
    total_assets = Column('total_assets', Float(), nullable=True, comment='资产总额')
    total_fixed_assets = Column('total_fixed_assets', Float(), nullable=True, comment='固定资产总额')
    ...
    main_business_revenue = Column('main_business_revenue', Float(), nullable=True, comment='主营业务收入')
...
class DwdOrgBankruptcyPublicCases(Base):
    ...
    admin_principal = Column('admin_principal', String(255), nullable=True, comment='管理人主要负责人')
...
class DwdOrgBankruptcyPublicCasesList(Base):
    ...
    bankruptcy_party_id = Column('bankruptcy_party_id', String(255), nullable=True, comment='唯一索引id')
    case_no = Column('case_no', String(255), nullable=True, comment='案号')
    related_person_name = Column('related_person_name', String(255), nullable=True, comment='相关人名称')
    party_role_type = Column('party_role_type', String(255), nullable=True, comment='当事人角色类型')
    ...
    social_credit_code = Column('social_credit_code', String(255), nullable=True, comment='统一社会信用代码')
    public_date = Column('public_date', String(255), nullable=True, comment='公开时间')
    is_deleted = Column('is_deleted', String(255), nullable=True, comment='是否删除')
    data_source = Column('data_source', String(255), nullable=True, comment='数据来源')
    created_time = Column('created_time', DateTime(), nullable=True, comment='创建时间')
...
class DwdOrgBidInfo(Base):
    ...
    tender_social_credit_code = Column('tender_social_credit_code', String(50), nullable=True, comment='采购单位统一社会信用代码')
    ...
    winner_social_credit_code = Column('winner_social_credit_code', String(50), nullable=True, comment='中标单位统一社会信用代码')
    announcement_title = Column('announcement_title', String(255), nullable=True, comment='公告标题')
    announcement_content = Column('announcement_content', String(50), nullable=True, comment='中标成交信息')
    data_source = Column('data_source', String(50), nullable=True, comment='数据来源')
    created_time = Column('created_time', String(50), nullable=True, comment='创建时间')
    updated_time = Column('updated_time', String(50), nullable=True, comment='更新时间')
...
class DwdOrgCompanyChattel(Base):
    ...
    guarantee_amount = Column('guarantee_amount', String(255), nullable=True, comment='被担保债权数额')
...
class DwdOrgCompanyJustice(Base):
    ...
    org_id = Column('org_id', String(255), nullable=True, comment='机构id')
    judicial_assist_id = Column('judicial_assist_id', String(255), nullable=True, comment='司法协助记录id')
    ...
    use_flag = Column('use_flag', String(255), nullable=True, comment='使用标记')
    status = Column('status', String(255), nullable=True, comment='状态')
    executed_person_type = Column('executed_person_type', String(255), nullable=True, comment='被执行人类型')
    executed_company_id = Column('executed_company_id', String(255), nullable=True, comment='被执行人的company_id')
    name_cn = Column('name_cn', String(255), nullable=True, comment='机构名称')
    social_credit_code = Column('social_credit_code', String(255), nullable=True, comment='统一社会信用代码')
    data_source = Column('data_source', String(255), nullable=True, comment='数据来源')
    created_time = Column('created_time', DateTime(), nullable=True, comment='创建时间')
...
class DwdOrgCompanyPledge(Base):
    ...
    pledge_reg_date = Column('pledge_reg_date', String(255), nullable=True, comment='股权出质设立登记日期')
    status = Column('status', String(255), nullable=True, comment='状态')
    public_date = Column('public_date', String(255), nullable=True, comment='公示日期')
    cancel_date = Column('cancel_date', String(255), nullable=True, comment='注销日期')
    cancel_reason = Column('cancel_reason', Text(), nullable=True, comment='注销原因')
    ...
    pledgor_company_id = Column('pledgor_company_id', String(255), nullable=True, comment='机构出质人的company_id')
    pledgor_company_name = Column('pledgor_company_name', String(255), nullable=True, comment='机构出质人名称')
    pledgor_credit_code = Column('pledgor_credit_code', String(255), nullable=True, comment='机构出质人统一社会信用代码')
    pledgor_type = Column('pledgor_type', String(255), nullable=True, comment='出质人类型')
    pledgee_company_id = Column('pledgee_company_id', String(255), nullable=True, comment='机构质权人的company_id')
    pledgee_company_name = Column('pledgee_company_name', String(255), nullable=True, comment='机构质权人名称')
    pledgee_credit_code = Column('pledgee_credit_code', String(255), nullable=True, comment='机构质权人统一社会信用代码')
...
class DwdOrgCompanyPunish(Base):
    ...
    license_info = Column('license_info', String(50), nullable=True, comment='暂扣或吊销证照名称及编号')
...
class DwdOrgExecutiveInfo(Base):
    ...
    executives_position = Column('executives_position', String(50), nullable=True, comment='职位名称')
    data_source = Column('data_source', String(50), nullable=True, comment='数据来源')
    created_time = Column('created_time', String(50), nullable=True, comment='创建时间')
    updated_time = Column('updated_time', String(50), nullable=True, comment='更新时间')
...
class DwdOrgFinancingInfo(Base):
    ...
    funding_currency_code = Column('funding_currency_code', String(50), nullable=True, comment='金额币种')
...
class DwdOrgHelsInfo(Base):
    ...
    org_name_en = Column('org_name_en', String(256), nullable=True, comment='高校/科研机构名称(英文)')
...
class DwdOrgImportantNewsInfo(Base):
    ...
    original_textlink = Column('original_textlink', String(255), nullable=True, comment='咨询原文链接')
    data_source = Column('data_source', String(50), nullable=True, comment='数据来源')
    created_time = Column('created_time', String(50), nullable=True, comment='创建时间')
    updated_time = Column('updated_time', String(50), nullable=True, comment='更新时间')
...
class DwdOrgInvestInfo(Base):
    ...
    inv_social_credit_code = Column('inv_social_credit_code', String(50), nullable=True, comment='被投资企业统一社会信用代码')
...
class DwdOrgMergerAcquisitionInfo(Base):
    ...
    acquiring_org_id = Column('acquiring_org_id', String(50), nullable=True, comment='发起收购企业id')
...
class DwdOrgOptJudicialCase(Base):
    ...
    current_procedure = Column('current_procedure', String(50), nullable=True, comment='当前审理程序')
...
class DwdOrgRegInfo(Base):
    ...
    registered_capital_value = Column('registered_capital_value', Float(), nullable=True, comment='注册资本金')
    capital_currency_code = Column('capital_currency_code', String(50), nullable=True, comment='资本货币代码')
    data_source = Column('data_source', String(50), nullable=True, comment='数据来源')
    created_time = Column('created_time', String(50), nullable=True, comment='创建时间')
    updated_time = Column('updated_time', String(50), nullable=True, comment='更新时间')
...
class DwdOrgRiskCourtAnnouncement(Base):
    ...
    notice_type_name = Column('notice_type_name', String(255), nullable=True, comment='公告类型名称')
    ...
    handle_level_name = Column('handle_level_name', String(255), nullable=True, comment='处理等级名称')
    ...
    publish_page_no = Column('publish_page_no', String(255), nullable=True, comment='公告刊登版面页码')
...
class DwdOrgRiskCourtFiledCase(Base):
    ...
    norm_case_status = Column('norm_case_status', String(255), nullable=True, comment='归一化后案件状态')
...
class DwdOrgRiskCourtFiledCaseLitigant(Base):
    ...
    classified_org_type = Column('classified_org_type', String(255), nullable=True, comment='归类后企业类型')
    org_id = Column('org_id', String(255), nullable=True, comment='机构id')
    name_cn = Column('name_cn', String(255), nullable=True, comment='机构名称')
    social_credit_code = Column('social_credit_code', String(255), nullable=True, comment='统一社会信用代码')
    use_flag = Column('use_flag', String(255), nullable=True, comment='使用标志')
...
class DwdOrgRiskCourtNotice(Base):
    ...
    case_cause = Column('case_cause', String(255), nullable=True, comment='案由')
    case_type = Column('case_type', String(255), nullable=True, comment='案件类型')
    jurisdiction_area = Column('jurisdiction_area', String(255), nullable=True, comment='案件管辖区域')
    plaintiff_appellant = Column('plaintiff_appellant', String(255), nullable=True, comment='原告上诉人')
    defendant_appellee = Column('defendant_appellee', String(255), nullable=True, comment='被告被上诉人')
    party = Column('party', String(255), nullable=True, comment='当事人')
    ...
    original_url = Column('original_url', Text(), nullable=True, comment='原始连接URL')
    is_hidden = Column('is_hidden', String(255), nullable=True, comment='是否不展示')
    data_source_2 = Column('data_source_2', String(255), nullable=True, comment='数据来源（重复字段，已重命名避免冲突）')
    created_time = Column('created_time', DateTime(), nullable=True, comment='创建时间')
    updated_time = Column('updated_time', DateTime(), nullable=True, comment='更新时间')
...
class DwdOrgRiskLawsuit(Base):
    ...
    judgment_doc_id = Column('judgment_doc_id', String(255), nullable=True, comment='裁判文书网文书id')
...
class DwdOrgRiskLawsuitList(Base):
    ...
    party_type = Column('party_type', String(255), nullable=True, comment='当事人类型')
    related_person_name = Column('related_person_name', String(255), nullable=True, comment='相关人名称')
    doc_publish_date = Column('doc_publish_date', String(255), nullable=True, comment='文书公布日期')
    case_cause = Column('case_cause', String(255), nullable=True, comment='案由')
    use_flag = Column('use_flag', String(255), nullable=True, comment='使用标志')
    is_hidden = Column('is_hidden', String(255), nullable=True, comment='是否不展示')
    org_id = Column('org_id', String(255), nullable=True, comment='机构id')
...
class DwdOrgRiskShixin(Base):
    ...
    legal_obligation = Column('legal_obligation', Text(), nullable=True, comment='生效法律文书确定的义务')
    fulfillment_status = Column('fulfillment_status', String(50), nullable=True, comment='被执行人的履行情况')
    dishonest_behavior = Column('dishonest_behavior', String(50), nullable=True, comment='失信被执行人行为具体情形')
...
class DwdOrgRiskTaxPunish(Base):
    ...
    legal_gender = Column('legal_gender', String(50), nullable=True, comment='法定代表人或者负责人性别')
    legal_id_type = Column('legal_id_type', String(50), nullable=True, comment='法定代表人或者负责人证件类型')
    legal_id_no = Column('legal_id_no', String(50), nullable=True, comment='法定代表人或者负责人证件号码')
    ...
    punish_basis = Column('punish_basis', String(1000), nullable=True, comment='相关法律依据及税务处理处罚情况')
...
class DwdOrgRiskXianxiao(Base):
    ...
    rhc_person_name = Column('rhc_person_name', String(50), nullable=True, comment='限制高消费人员名称')
    filing_date = Column('filing_date', String(50), nullable=True, comment='立案时间')
    ...
    xhfgk_doc_url = Column('xhfgk_doc_url', String(500), nullable=True, comment='限制高消费令文件url')
    use_flag = Column('use_flag', Integer(), nullable=True, comment='使用标记')
...
class DwdOrgRiskZhongben(Base):
    ...
    executed_person_name = Column('executed_person_name', String(255), nullable=True, comment='被执行人姓名名称')
    ...
    exec_target_amount = Column('exec_target_amount', Numeric(20, 2), nullable=True, comment='执行标的金额')
    unfulfilled_amount = Column('unfulfilled_amount', Numeric(20, 2), nullable=True, comment='未履行标的金额')
    org_id = Column('org_id', String(255), nullable=True, comment='机构id')
    name_cn = Column('name_cn', String(255), nullable=True, comment='机构名称')
    social_credit_code = Column('social_credit_code', String(255), nullable=True, comment='统一社会信用代码')
...
class DwdOrgShareholderInfo(Base):
    ...
    ownership_percentage = Column('ownership_percentage', Float(), nullable=True, comment='所有权占比(%)')
    data_source = Column('data_source', String(50), nullable=True, comment='数据来源')
    created_time = Column('created_time', String(50), nullable=True, comment='创建时间')
    updated_time = Column('updated_time', String(50), nullable=True, comment='更新时间')
...
class DwdOrgStockFinanceInfo(Base):
    ...
    total_liabilities = Column('total_liabilities', Numeric(20, 2), nullable=True, comment='负债总额(元)')
    operating_revenue = Column('operating_revenue', Numeric(20, 2), nullable=True, comment='营业收入(元)')
    gross_revenue = Column('gross_revenue', Numeric(20, 2), nullable=True, comment='营业总收入(元)')
    main_business_revenue = Column('main_business_revenue', Numeric(20, 2), nullable=True, comment='主营业务收入(元)')
    ...
    oper_cash_flow = Column('oper_cash_flow', Numeric(20, 2), nullable=True, comment='经营活动现金流(元)')
    owners_equity = Column('owners_equity', Numeric(20, 2), nullable=True, comment='所有者权益合计(元)')
    employees_number = Column('employees_number', Integer(), nullable=True, comment='从业人数')
    research_development_amount = Column('research_development_amount', Numeric(20, 2), nullable=True, comment='研发投入金额(元)')
    data_source = Column('data_source', String(50), nullable=True, comment='数据来源')
    created_time = Column('created_time', String(50), nullable=True, comment='创建时间')
    updated_time = Column('updated_time', String(50), nullable=True, comment='更新时间')
...
class DwdOrgTbJudicialSale(Base):
    ...
    asset_disposal_unit = Column('asset_disposal_unit', String(255), nullable=True, comment='资产处置单位')
    ...
    notice_content_path = Column('notice_content_path', Text(), nullable=True, comment='公告内容存储路径')
    auction_start_date = Column('auction_start_date', String(255), nullable=True, comment='拍卖开始日期')
    auction_end_date = Column('auction_end_date', String(255), nullable=True, comment='拍卖截止日期')
