...
class OdsZhProject(Base):
    ...
    funded_institution = Column('funded_institution', String(255), nullable=True, comment='依托单位')
    ...
    participating_institution = Column('participating_institution', String(255), nullable=True, comment='参与单位')
    ...
    final_report_abstract = Column('final_report_abstract', Text(), nullable=True, comment='结题摘要')
...
class OdsZhProjectOutput(Base):
    ...
    journal_articles_count = Column('journal_articles_count', Integer(), nullable=True, comment='期刊文章数量')
    conference_papers_count = Column('conference_papers_count', Integer(), nullable=True, comment='会议论文数量')
    books_count = Column('books_count', Integer(), nullable=True, comment='图书专著数量')
    degree_papers_count = Column('degree_papers_count', Integer(), nullable=True, comment='学位论文数量')
    patents_count = Column('patents_count', Integer(), nullable=True, comment='专利数量')
    clinical_trials_count = Column('clinical_trials_count', Integer(), nullable=True, comment='临床试验数量')
    ...
    other_outputs_count = Column('other_outputs_count', Integer(), nullable=True, comment='其他产出数量')
    output_journal_articles = Column('output_journal_articles', Text(), nullable=True, comment='期刊文章')
    output_conference_papers = Column('output_conference_papers', Text(), nullable=True, comment='会议论文')
    ...
    output_clinical_trials = Column('output_clinical_trials', Text(), nullable=True, comment='临床试验')
