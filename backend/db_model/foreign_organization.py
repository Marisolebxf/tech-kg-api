...
class DwdForgAggIdentifier(Base):
    ...
    ename_en = Column("ename_en", String(500), nullable=True, comment=ENTERPRISE_ENGLISH_NAME)
...
class DwdForgBeneficiaryInfo(Base):
    ...
    bo_country_code = Column(
        "bo_country_code", String(255), nullable=True, comment="受益人所在国家代码"
    )
...
class DwdForgExecutiveInfo(Base):
    ...
    executives_position = Column(
        "executives_position", String(500), nullable=True, comment="高管职位"
    )
...
class DwdForgProfile(Base):
    ...
    ename_en = Column("ename_en", String(1000), nullable=True, comment=ENTERPRISE_ENGLISH_NAME)
    business_desc = Column("business_desc", String(2000), nullable=True, comment="业务简介")
    products_services = Column(
        "products_services", String(2000), nullable=True, comment="主要产品与服务"
    )
...
class DwdForgShareholder(Base):
    ...
    sh_country_code = Column(
        "sh_country_code", String(255), nullable=True, comment="股东所在国家代码"
    )
    sh_direct_pct = Column(
        "sh_direct_pct", String(50), nullable=True, comment="股东直接持股比例（%）"
    )
...
class DwdForgUltimateControl(Base):
    ...
    entity_country_code = Column(
        "entity_country_code", String(32), nullable=True, comment="实控人国家代码"
    )
