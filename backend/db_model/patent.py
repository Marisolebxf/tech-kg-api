...
class OdsPatent(Base):
    ...
    id = Column('id', String(20), primary_key=True, nullable=False, comment='专利公布号(与DOCDB兼容)')
    publication_number = Column('publication_number', String(20), nullable=True, comment='专利公布号')
    pct_publication_number = Column('pct_publication_number', String(20), nullable=True, comment='pct公开号')
    application_number = Column('application_number', String(20), nullable=True, comment='专利申请号')
    ...
    application_number_formatted = Column('application_number_formatted', String(20), nullable=True, comment='格式化的申请号')
    ...
    spif_publication_number = Column('spif_publication_number', String(20), nullable=True, comment='SPIF标准发布编号')
    spif_application_number = Column('spif_application_number', String(20), nullable=True, comment='SPIF标准申请号')
    ...
    claims_localized_html = Column('claims_localized_html', Text(), nullable=True, comment='权利要求html')
    description_localized = Column('description_localized', Text(), nullable=True, comment='说明书')
    description_localized_html = Column('description_localized_html', Text(), nullable=True, comment='说明书html')
    ...
    current_assignee = Column('current_assignee', Text(), nullable=True, comment='当前受让人/申请人')
    assignee_harmonized = Column('assignee_harmonized', Text(), nullable=True, comment='受让人/申请人信息')
    ...
    entity_status = Column('entity_status', String(7), nullable=True, comment='美国专利商标局实体状态')
    ...
    non_patent_citations = Column('non_patent_citations', Text(), nullable=True, comment='非专利引用')
    legal_events = Column('legal_events', Text(), nullable=True, comment='法律事件')
    anticipated_expiration = Column('anticipated_expiration', Date(), nullable=True, comment='预计到期日')
    ...
    dwpi_basic = Column('dwpi_basic', String(20), nullable=True, comment='DWPI基本专利，指第一个输入到DWPI数据库的同族专利成员')
    ...
    license_type = Column('license_type', Integer(), nullable=True, comment='许可类型，如独占许可、排他许可、普通许可等许可方式')
    license_country = Column('license_country', Text(), nullable=True, comment='许可地国家，专利许可在哪些国家或地区有效')
    ...
    subject_classification = Column('subject_classification', Text(), nullable=True, comment='学科分类')
    ...
    dwpi_priority_number = Column('dwpi_priority_number', String(20), nullable=True, comment='DWPI优先权号')
    dwpi_priority_country = Column('dwpi_priority_country', String(2), nullable=True, comment='DWPI优先权国别')
    ...
    inpadoc_family_id = Column('inpadoc_family_id', String(8), nullable=True, comment='INPADOC同族编号')
    independent_claims_localized = Column('independent_claims_localized', Text(), nullable=True, comment='独立权利要求')
    independent_claims_localized_html = Column('independent_claims_localized_html', Text(), nullable=True, comment='独立权利要求html')
    ...
    current_assignee_harmonized = Column('current_assignee_harmonized', Text(), nullable=True, comment='当前受让人/申请人信息')
    current_inventor = Column('current_inventor', Text(), nullable=True, comment='当前发明人')
    current_inventor_harmonized = Column('current_inventor_harmonized', Text(), nullable=True, comment='当前发明者信息')
    ...
    assistant_examiner = Column('assistant_examiner', Text(), nullable=True, comment='助理审查员信息')
    priority_country = Column('priority_country', String(2), nullable=True, comment='优先权国家/地区')
    ...
    first_publication_date = Column('first_publication_date', Date(), nullable=True, comment='首次公开日')
    ...
    earliest_priority_date = Column('earliest_priority_date', Date(), nullable=True, comment='最早优先权日')
    ...
    epds_legal_status = Column('epds_legal_status', Integer(), nullable=True, comment='EP指定国家/地区法律状态')
    ...
    priority_country_count = Column('priority_country_count', Integer(), nullable=True, comment='优先权国家/地区个数')
    ...
    license_effective_date = Column('license_effective_date', Date(), nullable=True, comment='许可生效日')
    ...
    review_invalid_applicant = Column('review_invalid_applicant', Text(), nullable=True, comment='复审/无效请求人')
    review_invalid_decision_number = Column('review_invalid_decision_number', Text(), nullable=True, comment='决定号')
    review_invalid_commission_number = Column('review_invalid_commission_number', Text(), nullable=True, comment='委内编号')
    review_invalid_decision_date = Column('review_invalid_decision_date', Date(), nullable=True, comment='决定/发文日')
    review_invalid_decision_type = Column('review_invalid_decision_type', Text(), nullable=True, comment='决定类型')
    review_invalid_decision = Column('review_invalid_decision', Text(), nullable=True, comment='决定')
    review_invalid_decision_point = Column('review_invalid_decision_point', Text(), nullable=True, comment='决定要点')
    review_invalid_decision_case_mainpoint = Column('review_invalid_decision_case_mainpoint', Text(), nullable=True, comment='案由')
    review_invalid_legal_basis = Column('review_invalid_legal_basis', Text(), nullable=True, comment='法律依据')
    review_invalid_fulltext = Column('review_invalid_fulltext', Text(), nullable=True, comment='复审/无效全文')
...
class OdsPatentBiblio(Base):
    ...
    patent_id = Column('patent_id', String(20), primary_key=True, nullable=False, comment='专利主键ID')
    ...
    related_documents = Column('related_documents', Text(), nullable=True, comment='分案申请、继续申请信息')
    classification_data = Column('classification_data', Text(), nullable=True, comment='分类数据')
    application_reference = Column('application_reference', Text(), nullable=True, comment='申请信息')
    publication_reference = Column('publication_reference', Text(), nullable=True, comment='公开信息')
    pct_or_regional_filing_data = Column('pct_or_regional_filing_data', Text(), nullable=True, comment='PCT申请信息')
    dates_of_public_availability = Column('dates_of_public_availability', Text(), nullable=True, comment='授权信息')
    pct_or_regional_publishing_data = Column('pct_or_regional_publishing_data', Text(), nullable=True, comment='PCT公开信息')
