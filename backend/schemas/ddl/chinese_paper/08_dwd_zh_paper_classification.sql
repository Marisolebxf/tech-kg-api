CREATE TABLE IF NOT EXISTS dwd_zh_paper_classification (
    ...
    `subject_category` VARCHAR(20) COMMENT '期刊所属的大类学科领域。',
    `subject_subcategory` VARCHAR(20) COMMENT '期刊所属的细分学科领域。',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='中文论文分类信息';
