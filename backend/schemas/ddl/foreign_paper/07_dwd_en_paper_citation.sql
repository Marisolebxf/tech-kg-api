CREATE TABLE IF NOT EXISTS dwd_en_paper_citation (
    ...
    `citation_name_en` VARCHAR(1024) COMMENT '引用文献的英文标题名称。',
    `citation_publication_name_en` VARCHAR(1024) COMMENT '参考文献出版物的英文名称。',
    ...
    KEY `idx_07_citation_publication_name_en` (`citation_publication_name_en`(191))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='英文论文引用文献信息';
