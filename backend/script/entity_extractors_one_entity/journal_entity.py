"""One-entity transform for Journal（平台喂数抽取：脚本只输出实体 JSON）。"""
...
SOURCES = [
    {"table": "dwd_zh_journal", "pk": "publication_id", "time": "update_time"},
    {"table": "dwd_en_journal", "pk": "publication_id", "time": "update_time"},
]
