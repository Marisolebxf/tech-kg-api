...
@pytest.mark.parametrize('value', [datetime(2026, 5, 27, 16, 39, 38), '2026-05-27 16:39:38', '2026-05-27T16:39:38+08:00'])
...
async def test_representative_achievements_use_shared_paper_titles():
    ...
    assert item['representativeAchievements'] == [{'id': 'paper_2', 'title': 'A verified joint paper'}]
