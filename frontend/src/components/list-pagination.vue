...
<style scoped>
.list-pagination{display:flex;align-items:center;flex:0 0 auto;gap:16px;height:56px;box-sizing:border-box;padding:12px 16px;border-top:1px solid #e5e6eb;background:#fff;color:#86909c;font-size:12px;line-height:20px}
...
.list-pagination :deep(.arco-pagination-item){min-width:32px;height:32px;border-radius:4px;font-size:14px;line-height:22px}
