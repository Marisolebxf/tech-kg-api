...
<template>
  <div class="member-page">
    <header class="page-heading"><div><span>GLOBAL ADMINISTRATION</span><h1>成员管理</h1><p>普通用户自动拥有查询分析和提交修正权限，仅在这里维护全局管理员。</p></div><a-button :loading="loading" @click="load">刷新</a-button></header>
