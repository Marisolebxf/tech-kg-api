...
.security-hero span { color:#004ecc;font-size:10px;font-weight:700;letter-spacing:.16em; }.security-hero h1 { margin:7px 0 5px;font-size:25px; }.security-hero p { margin:0;color:#71819a;font-size:12px; }.security-hero>b { padding:7px 11px;border-radius:999px;background:#e8f8ef;color:#067647;font-size:10px; }
.message { margin:14px 0 0;padding:12px 14px;border-radius:7px;background:#edf5ff;color:#004ecc;font-size:11px; }.message.is-error { background:#fff0ee;color:#b42318; }
.security-summary { display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:14px; }.security-summary article { display:grid;grid-template-columns:42px minmax(0,1fr);gap:12px;padding:16px;border:1px solid #d1e1f5;border-radius:9px;background:#fff;box-shadow:0 7px 18px rgba(48,105,194,.06); }.security-summary i { display:grid;place-items:center;width:42px;height:42px;border-radius:10px;background:#eaf2ff;color:#004ecc;font-style:normal;font-weight:700; }.security-summary div { display:grid;gap:3px; }.security-summary span,.security-summary small { color:#8390a3;font-size:9px; }.security-summary strong { font-size:13px; }
