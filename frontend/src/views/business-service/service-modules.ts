...
export const serviceModules: ServiceModule[] = [
  ...
  },
  {
    ...
    summaryRows: [
      { label: '专家 A', value: '陈建国｜研究员' },
      { label: '专家 B', value: '刘芳｜教授' },
      { label: '合作成果类型', value: '论文、项目、专利' },
      { label: '成果总量', value: '17 项' },
      { label: '成果分布', value: '共同论文 10 篇、联合项目 4 项、合作专利 3 件' },
      { label: '共同研究领域', value: '智能计算、科技知识图谱、关系推理' },
      { label: '合作时间', value: '2018—2026' },
      { label: '核心贡献', value: '高水平论文与国家级联合项目' },
      { label: '合作模式', value: '长期稳定型科研合作' },
      { label: '代表成果', value: '智能计算协同研究、科技知识图谱联合项目' },
      { label: '关系置信度', value: '0.94' },
    ],
    evidence: [
      '按论文、专利、项目邻居求交汇总共同成果。',
