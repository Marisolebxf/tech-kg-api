...
export const serviceModules: ServiceModule[] = [
  ...
  },
  {
    ...
    requestFields: [
      ...
      { name: 'timeRangeStart', type: 'month', required: '否', description: '成果开始月份 YYYY-MM；与结束月份同时填写，二者均留空表示不限' },
  ...
  },
  {
    ...
    requestFields: [
      { name: 'expert_id', type: 'string', required: '是', maxLength: 64, placeholder: '请输入专家，如 person_94447y38', description: '请输入专家唯一标识，最多 64 个字符' },
      { name: 'enterprise_name', type: 'string', required: '否', maxLength: 64, placeholder: '选填，企业名称，如 徐工集团', description: '企业名称模糊筛选，可留空，最多 64 个字符，不能包含 !@#￥%& 等异常字符' },
      { name: 'role_type', type: 'string', required: '否', maxLength: 64, placeholder: '选填，角色，如 研究员', description: '专家企业角色筛选，可留空，最多 64 个字符' },
      { name: 'industry', type: 'string', required: '否', maxLength: 64, placeholder: '选填，行业方向，如 智能制造', description: '企业行业方向筛选，可留空，最多 64 个字符，不能包含 !@#￥%& 等异常字符' },
      { name: 'key_tech_enterprise_only', type: 'boolean', defaultValue: 'true', required: '否', description: '只保留重点科技企业，默认 true', options: ['true', 'false'] },
    ],
    responseFields: apiResponseFields,
  ...
  },
  {
    ...
    requestFields: [
      { name: 'chain_node_id', type: 'string', required: '是', maxLength: 64, placeholder: '请输入产业链节点，如 IC0007007', description: '请输入产业链节点标识，最多 64 个字符' },
      { name: 'top_n', type: 'number', required: '否', defaultValue: '10', placeholder: '选填，1-50，默认 10', description: '返回事件数量，1-50 的整数，默认 10' },
      { name: 'event_type', type: 'string', required: '否', maxLength: 64, placeholder: '选填，事件类型，如 stock_finance', description: '事件类型筛选，可留空，最多 64 个字符' },
      { name: 'time_range_start', type: 'month', required: '否', placeholder: '选填，开始年月，如 2025-01', description: '起始年月 YYYY-MM；与结束年月同时填写，留空表示不筛选' },
      { name: 'time_range_end', type: 'month', required: '否', placeholder: '选填，结束年月，如 2025-12', description: '结束年月 YYYY-MM；与开始年月同时填写，留空表示不筛选' },
      { name: 'max_orgs', type: 'number', required: '否', defaultValue: '20', maxLength: 64, placeholder: '选填，1-50，默认 20', description: '最多扫描企业数，1-50 的整数，默认 20' },
    ],
    responseFields: apiResponseFields,
    ...
    summaryRows: [
      ...
      { label: '关联专家', value: '18 人｜陈建国、李佳宁等 18 人' },
  ...
  },
  {
    ...
    requestFields: [
      { name: 'industry', type: 'string', required: '是', placeholder: '请输入产业关键词，如 人工智能', description: '产业关键词，必填，如 人工智能 / 集成电路，最多 64 个字符，不能包含 !@#￥%& 等异常字符' },
