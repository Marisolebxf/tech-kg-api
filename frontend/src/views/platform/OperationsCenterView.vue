  ...
  <div class="ops-page">
    ...
    <section class="ops-panel">
      ...
      <a-form :model="{ keyword, severity, domain, status, reviewStatusFilter, reviewKindFilter }" :class="['ops-filter', { 'is-review': mode === 'review' }]" layout="vertical">
        ...
        <a-form-item v-else field="keyword"><input v-model="keyword" :maxlength="SEARCH_KEYWORD_MAX_LENGTH" aria-label="搜索批次、对象或异常原因" placeholder="搜索批次、对象、异常原因" /></a-form-item>
        <template v-if="mode === 'alerts'">
