"""从 gkx_element 映射并装载 Patent、Keyword 和 HAS_KEYWORD 到配置的图空间。"""
...
# 2. MySQL数据读取
SQL_FILE = TEST_DIR / "patent_entity_extract.sql"
...
DDL_FILE = BACKEND_ROOT / "schemas" / "ddl" / "patent_ddl.ngql"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=f"从 MySQL 装载专利图数据到 {GRAPH_SPACE}"
    )
